...
// Demo mode - when true, uses local mock data instead of Medusa API
// Enable when no Medusa backend is available or publishable key is not set
export const isDemoMode = !import.meta.env.VITE_MEDUSA_PUBLISHABLE_KEY;
